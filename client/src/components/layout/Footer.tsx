    ...
    <footer className="bg-background border-t border-white/5 pt-20 pb-10" id="contact">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="text-center md:text-left space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed max-w-xs mx-auto md:mx-0">
              Un santuario de coctelería y gastronomía japonesa en el corazón de Montreal. Donde la tradición se encuentra con la noche.
            </p>
          ...
          <div className="text-center md:text-left space-y-6">
            <h4 className="text-lg font-cinzel text-secondary tracking-widest">CONTACTO</h4>
            <div className="space-y-4 text-sm text-gray-300">
              <div className="flex flex-col md:flex-row items-center md:items-start space-y-2 md:space-y-0 md:space-x-3">
                ...
                <span>4175 Boul. Saint-Laurent,<br />Montréal, QC H2W 1Y7, Canadá</span>
              </div>
              <div className="flex flex-col md:flex-row items-center md:items-start space-y-2 md:space-y-0 md:space-x-3">
          ...
          {/* Hours */}
          <div className="text-center md:text-left space-y-6">
            <h4 className="text-lg font-cinzel text-secondary tracking-widest">HORARIOS</h4>
            <div className="space-y-2 text-sm text-gray-300">
              ...
              <div className="flex justify-center md:justify-between pt-2 opacity-50">
                ...
                <span className="ml-4">Cerrado</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-8 text-center text-xs text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Big in Japan Bar. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
